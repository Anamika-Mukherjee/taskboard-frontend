//Collaboration Sidebar Component for small devices (used in Collaborations Pages)
"use client";
...
interface MobileCollabSidebarProps{
    setOpenMenu: React.Dispatch<SetStateAction<boolean>>;
}

const MobileCollabSidebar: React.FC<MobileCollabSidebarProps> = ({setOpenMenu}) => {
...
export default MobileCollabSidebar;
